...
struct CardView: View {
    ...
    // Must drag 80% of the screen for a like or dislike
...
struct CardView_Previews: PreviewProvider {
    static var previews: some View {
        CardView(person: Person.examplePerson, fullscreenMode: .constant(true))
        CardView(person: Person.examplePerson, fullscreenMode: .constant(false))
    }
}
